...
\end{equation}
In order to write down the full lattice action for the scalar field theory, we need to consider the dimesnionality of the lattice parameters like the field value $\phi(na)$ and the lattice mass $M$. We need to maintain the dimensionless-ness of the Euclidean lattice action. Looking at Eq.~\eqref{eqn:action} and Eq.~\eqref{eqn:laplatt}, we get \sideex{There is an exercise related to this!}
...
\end{equation}
\textcolor{red}{missing:   - what breaks in symmetries - how we recover the orginal theory}
