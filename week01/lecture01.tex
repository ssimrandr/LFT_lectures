...
To begin we consider the (continuum) Euclidean action corresponding to the scalar field $\phi$ field in 4 spacetime dimensions (from now on $x$ denotes the 4 vector $(x_1,x_2,x_3,x_4)$),
